...
TOPIC_PUB_TEMP = 'EGR314/Team309/Temperature'
TOPIC_PUB_HUM = 'EGR314/Team309/Humidity'
TOPIC_PUB_TIME = 'EGR314/Team309/Timer'
...
async def receiver():
    ...
    while True:
        ...
        if res==b'-':
            await client.publish(TOPIC_PUB_TEMP, b, qos=1)
            print('published', b)
            b = b''
        elif res==b'+':
            ...
            await client.publish(TOPIC_PUB_TIME, b, qos=1)
            print('published', b)
            b = b''
        else:
            b+=res
